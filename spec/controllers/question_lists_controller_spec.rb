...
RSpec.describe QuestionListsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested question_list as @question_list" do
      question_list = QuestionList.create! valid_attributes
      get :show, {:id => question_list.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested question_list as @question_list" do
      question_list = QuestionList.create! valid_attributes
      get :edit, {:id => question_list.to_param}, valid_session
      expect(assigns(:question_list)).to eq(question_list)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new QuestionList" do
        expect {
          post :create, {:question_list => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved question_list as @question_list" do
        post :create, {:question_list => invalid_attributes}, valid_session
        expect(assigns(:question_list)).to be_a_new(QuestionList)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested question_list" do
        question_list = QuestionList.create! valid_attributes
        put :update, {:id => question_list.to_param, :question_list => new_attributes}, valid_session
      ...
      it "assigns the requested question_list as @question_list" do
        question_list = QuestionList.create! valid_attributes
        put :update, {:id => question_list.to_param, :question_list => valid_attributes}, valid_session
        expect(assigns(:question_list)).to eq(question_list)
      end
    ...
    context "with invalid params" do
      it "assigns the question_list as @question_list" do
        question_list = QuestionList.create! valid_attributes
        put :update, {:id => question_list.to_param, :question_list => invalid_attributes}, valid_session
        expect(assigns(:question_list)).to eq(question_list)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested question_list" do
      question_list = QuestionList.create! valid_attributes
      expect {
        delete :destroy, {:id => question_list.to_param}, valid_session
      }.to change(QuestionList, :count).by(-1)
    end
